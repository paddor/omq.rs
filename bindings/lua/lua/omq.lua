...
---@field recv fun(self: omq.Socket, capacity?: integer, flags?: integer): string
---@field try_recv fun(self: omq.Socket, capacity?: integer): string|nil
---@field recv_parts fun(self: omq.Socket, capacity?: integer, flags?: integer): string[]
...
---@param options? {linger?: integer, send_timeout?: integer, recv_timeout?: integer, send_hwm?: integer, recv_hwm?: integer, arena_threshold?: integer, subscribe?: string} socket options applied before bind/connect. `arena_threshold` overrides OMQ.lua's native 4 KiB default; `-1` restores the native default.
