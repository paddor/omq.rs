...
- Update the queue runtime used by the bundled tokio backend.

## [0.5.18] - 2026-09-08

### Changed

- *(deps)* Bump `omq-tokio` to 0.22.2 and `yring` to 0.3.16.

## [0.5.17] - 2026-09-05

### Changed

- *(deps)* Bump `omq-tokio` to 0.22.1 and `yring` to 0.3.15.
...
- *(deps)* Bump `omq-tokio` to 0.21.1 and `yring` to 0.3.13.
